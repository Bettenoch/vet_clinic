...
(
    ...
    neutered boolean,
    weight_kg numeric,
    CONSTRAINT animals_pkey PRIMARY KEY
(id)
)


ALTER TABLE
IF EXISTS "VET1".animals
    OWNER to postgres;
...
CREATE TABLE
IF NOT EXISTS "VET1".owners
(
    id integer NOT NULL GENERATED ALWAYS AS IDENTITY
( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 2147483647 CACHE 1 ),
    full_name character varying COLLATE pg_catalog."default",
    age integer,
    CONSTRAINT owners_pkey PRIMARY KEY
(id)
)

ALTER TABLE
IF EXISTS "VET1".owners
    OWNER to postgres;

CREATE TABLE
IF NOT EXISTS "VET1".species
(
    id integer NOT NULL GENERATED ALWAYS AS IDENTITY
( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 2147483647 CACHE 1 ),
    name character varying COLLATE pg_catalog."default",
    CONSTRAINT species_pkey PRIMARY KEY
(id)
)
...
ALTER TABLE public.animals
    ADD COLUMN
IF NOT EXISTS species_id integer;
...
ALTER TABLE public.animals
	ADD COLUMN
IF NOT EXISTS owner_id integer;
...
--PART5
ALTER TABLE public.owners ADD COLUMN email VARCHAR
(120);

--CREATE INDEX TO IMPROVE EXECUTION TIME
CREATE INDEX visits_animal_id ON public.visits(animal_id);
CREATE INDEX visits_vet_id ON public.visits(vet_id);
CREATE INDEX owner_email_index ON public.owners(email);
